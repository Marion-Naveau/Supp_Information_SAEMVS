...
<!-- Added by: mnaveau, at: Mer 19 oct 2022 13:33:48 CEST -->
...
The file ‘CONTENT_OF_FOLDER’ contains a description of all files in this
GitHub directory.
...
and $\varphi_i = \mu + \beta^\top V_i+ \xi_i , \text{ with } \xi_i \overset{\text{i.i.d.}}{\sim} \mathcal{N}(0,\Gamma^2),$
